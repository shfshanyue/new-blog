---
title: "如何维护自己的测试示例代码"
description: "大家好，我是山月。 在我大学乃至刚毕业的两三年，在本地维护一个文件夹，维护所有的示例代码，用以新技术调研及学习一些新的 API 之类。 然而代码维护不成规矩，很多示例代码杂乱无章，写了之后再不会看第二眼。随着离职，示例代码文件夹被归为无意义且无用的代码一类，被一键格式化了。 今天，我总结下如何更好地维护自己的示例代码，不至于如同鸡肋一样食"
pubDatetime: 2021-09-15T00:00:00+08:00
