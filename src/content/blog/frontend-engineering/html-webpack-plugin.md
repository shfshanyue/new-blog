---
title: "html-webpack-plugin 原理解析"
description: "在现代前端开发中，如何把打包后的 JS 资源自动注入到 html 中？ 如果最终打包生成的 main.js 既没有做 code spliting，也没有做 hash 化路径。大可以通过在 index.html 中手动控制 JS 资源。 但往往事与愿违: 1. main.js 即我们最终生成的文件带有 hash 值，如 main.8a9b3"
      ...
      compilation.hooks.processAssets.tapAsync(
        ...
        (compilationAssets, callback) => {
          ...
          const assets = entryNames
            .map(entryName => compilation.entrypoints.get(entryName).getFiles())
            .flat();
