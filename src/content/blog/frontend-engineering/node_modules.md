---
title: "dev 与 devDep 的区别"
description: "当 require('package-hello') 时，假设 package-hello 是一个 npm 库，我们是如何找到该 package 的？ 1. 寻找当前目录的 node_modules/package-hello 目录 1. 如果未找到，寻找上一级的 ../node_modules/package-hello 目录，以此递归"
...
### _再一个问题: 如果有 lockfile 且安装时间不一致，最终 node_modules 结果如何_
