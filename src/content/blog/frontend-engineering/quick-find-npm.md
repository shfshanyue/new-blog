---
title: "如何找到一个合适的 npm 库"
description: "由于业务需求，我需要一个 React 的弹框组件，我应如何快速选择一个合适的 npm 库？ 在错误的网址进行搜索，事倍功半: 1. ~~某度~~ 在正确的网址进行搜索，事半功倍: 1. $1: 官方网站，权威网站 2. $1 3. $1 不要使用错误冗长的关键词搜索: ~~我需要一个 React 的弹框组件~~。 请使用正确的关键词进行搜"
pubDatetime: 2021-05-24T00:00:00+08:00
