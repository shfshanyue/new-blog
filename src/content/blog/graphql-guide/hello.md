...
description: "我们先写一个关于 graphql.js 的 hello, world 示例，并且围绕它展开对 graphql 的学习 由上，也可以看出 graphql 很关键的两个要素： schema 和 query 。而当我们开发 web 应用时， schema 将会是服务端的主体，而 query 存在于前端中，类似 REST 中的 API。"
