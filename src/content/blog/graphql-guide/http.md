...
description: "graphql 仅仅提供了 schema 与 operation/query 的用法，当我们在 web 中使用 graphql 时，就需要使用 HTTP 把 graphql 隔离为 client 与 server 两端。想象一个流程： 1. 前端发送 operation 到后端 1. 后端维护一个 schema 1. 后端根据前端的 op"
pubDatetime: 2019-09-08T22:00:00+08:00
tags: ["graphql"]
series: "GraphQL 指南"
seriesOrder: 4
draft: false
