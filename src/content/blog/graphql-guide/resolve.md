...
description: "再回到刚开始的 hello, world 的示例，用 graphql 表示如下 对以上章节的内容再梳理一遍： 1. 可以对 hello 进行查询，因为该字段在 Query 下 1. HELLO 查询所得到的 data.hello 是一个字符串 恩？我们好像把最重要的内容给漏了， hello 中的内容到底是什么？！而 resolve 函数就"
