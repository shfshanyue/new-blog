...
description: "从上文 $1 中可以看出 graphql 很关键的两个要素： schema 和 operation 。 而当我们开发 web 应用时， schema 将会是服务端的主体，而 operation 存在于前端中，类似 REST 中的 API。 我们先抽出 schema 的代码部分，这里有 GraphQLSchema ， GraphQLObje"
pubDatetime: 2019-09-07T00:00:00+08:00
tags: ["graphql"]
series: "GraphQL 指南"
seriesOrder: 3
draft: false
