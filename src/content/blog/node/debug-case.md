---
title: "Javascript 调试基础与示例"
description: "使用 Javascript 写代码，如论是在 Node 后端环境还是前端单页应用，调试是资深程序员的进身之阶！ 程序员的水平提示之路只有一条，那就是乐此不疲地调试代码。某非著名非大师山月如是说道。 + Resume : 执行到下一个断点 + Step Over : 执行下一语句 + Step Into : 执行下一语句，如遇到函数，则进入"
pubDatetime: 2020-02-20T10:20:00+08:00
tags: ["node"]
series: "Node 牛刀小试"
seriesOrder: 16
draft: false
