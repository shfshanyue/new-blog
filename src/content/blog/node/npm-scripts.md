...
description: "众所周知，一个 Javasript 项目的脚本类工具，可以使用 package.json 中的 scripts 字段来组织，简单来说，这就是 npm script 。 最典型最常用约定俗成的一个是 npm start ，用以启动项目： 约定俗成的还有很多，如下所列 + npm install + npm test + npm publis"
