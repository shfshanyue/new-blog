...
description: "当你拿出自己的智能手机，来一张美美的自拍时，这张自拍就包含了**拍摄时间、位置、机型信息、拍摄参数等等信息**，称作这个图片的 Metadata 。越来越多的国产手机支持把 各式各样的 Metadata 作为水印，同时有一些产品根据这些信息制作水印相机。据说去年有个人开发者的水印小程序大火，山月也曾跃跃欲试去开发一个。嗯，跑远了... 由"
pubDatetime: 2021-01-14T15:19:00+08:00
tags: ["performance"]
series: "Web 性能优化"
seriesOrder: 2
draft: false
...
![杭州-苏堤](/assets/web-performance/hang-sudi.jpeg)
...
![在 Mac 上读取 Metadata 信息](/assets/web-performance/hang-exif-sudi.png)
...
![JPEG Metadata 占用大小](/assets/web-performance/jpeg-metadata-size.jpg)
...
![使用 ImageOptim 进行图片格式压缩](/assets/web-performance/image-optim.png)
